...
sig
  ...
  val source_intro : string (* module name *) -> P.context -> string
  val source_outro : string (* module name *) -> P.context -> string
...
struct
  ...
  let print_source compunit p oc top_verbatim middle_verbatim bottom_verbatim =
    ...
    pp oc
      ...
      (C.source_intro compunit.U.module_name p.P.context)
      ...
      (C.source_outro compunit.U.module_name p.P.context)
