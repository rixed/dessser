...
sig
  ...
  (* High level API: *)
  val compile : ?dev_mode:bool -> ?extra_search_paths:string list -> ?optim:int -> link:link -> ?dst_fname:string -> ?comment:string -> ?outro:string -> ?keep_temp_files:bool -> U.t -> string
