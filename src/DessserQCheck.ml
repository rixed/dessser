...
let rec e0_gen l depth =
  ...
  let lst = [
    ...
    1, map E.Ops.u8 (int_bound 255) ;
    1, map E.Ops.u16 (int_bound 65535) ;
    1, map E.Ops.u24 (int_bound 16777215) ;
    ...
    1, map E.Ops.i8 (int_range (-128) 127) ;
    1, map E.Ops.i16 (int_range (-32768) 32767) ;
    1, map E.Ops.i24 (int_range (-8388608) 8388607) ;
    1, map (E.Ops.i32 % Int32.of_int) int ;
    1, map (E.Ops.i40 % Int64.of_int) int ;
    1, map (E.Ops.i48 % Int64.of_int) int ;
    1, map (E.Ops.i56 % Int64.of_int) int ;
    1, map (E.Ops.i64 % Int64.of_int) int ;
    1, map (E.Ops.i128 % Int128.of_int) int ;
    1, map E.Ops.bit bool ;
    1, map E.Ops.size small_nat ;
    1, map E.Ops.byte (int_bound 255) ;
    1, map E.Ops.word (int_bound 65535) ;
